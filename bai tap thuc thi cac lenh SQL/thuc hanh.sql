...
create table customers(
    ...
    contactFisrtName varchar(150) NOT NULL,
...
add column addressLine2 varchar(150) NOT NULL;

alter table customers
modify column addressLine2 varchar(150) DEFAULT NULL;

alter table customers
change contactFisrtName contactFirstName varchar(200) NOT NULL;
